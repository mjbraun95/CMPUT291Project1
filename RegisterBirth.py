...
def register_a_birth(username):
    ...
    Father = GetName.get_name("father")
    RegisterPerson.check(Father)

    #first and last name of mother
    Mother = GetName.get_name("mother")
    RegisterPerson.check(Mother)
    ...
    # register the person
    RegisterPerson.register_a_person(newborn_name, bdate, birth_place, address, phone)
